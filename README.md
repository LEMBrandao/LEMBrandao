...
I´m a proud brazilian, raised in the tropical city of **Natal-RN** (<!--NATAL_WEATHER-->28°C, Scattered Clouds<!--END_NATAL_WEATHER-->).  

In 2019, I moved to **Sweden** to grow as a scientist and expand my world.   
Since then, I´ve be living (and continuously adapting) in the small, charming city of **Uppsala** (<!--UPPSALA_WEATHER-->20°C, Overcast Clouds<!--END_UPPSALA_WEATHER-->).
...
Have a great <!--WEEKDAY-->Saturday<!--END_WEEKDAY-->!
=D
---
